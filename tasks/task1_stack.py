class BracketValidator:
    ...
    Реализуйте класс BracketValidator с
    методом is_valid(), который принимает строку, содержащую только
    символы '(', ')', '[', ']', '{', '}', и определяет, является ли она корректной.

    Условия корректности:
    - Каждая открывающая скобка должна иметь соответствующую
    закрывающую скобку того же типа.
